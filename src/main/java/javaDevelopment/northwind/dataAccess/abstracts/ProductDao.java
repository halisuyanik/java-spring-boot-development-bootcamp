...
public interface ProductDao extends JpaRepository<Product,Integer>{
	...
	@Query("Select new javaDevelopment.northwind.entities.dtos.ProductWithCategoryDto(p.id, p.productName, c.categoryName) From Category c Inner Join c.products p")
